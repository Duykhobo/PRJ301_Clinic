                        ...
                        <form action="${pageContext.request.contextPath}/MainController" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="username" class="form-control form-control-glass border-start-0 ps-0 ${not empty errors.username ? 'is-invalid' : ''}" value="${username}" required autofocus placeholder="Nhập tên đăng nhập">
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-password-wrapper">
                                    <div class="input-group">
                                        ...
                                        <input type="password" id="loginPassword" name="password" class="form-control form-control-glass border-start-0 ps-0 pe-5 ${not empty errors.password ? 'is-invalid' : ''}" required placeholder="Nhập mật khẩu">
                                    </div>
