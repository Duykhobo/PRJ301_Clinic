                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${app.paymentStatus == 'PAID'}">
                                                    <span class="badge bg-success bg-opacity-20 border border-success border-opacity-30 px-3 py-2 rounded-pill fw-bold text-emerald">
                                                ...
                                                <c:otherwise>
                                                    <span class="badge bg-warning bg-opacity-20 border border-warning border-opacity-30 px-3 py-2 rounded-pill fw-bold text-warning">
