        ...
        <form id="bookingForm" action="${pageContext.request.contextPath}/booking" method="POST" novalidate onsubmit="return validateBookingForm(event)">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <select name="serviceId" id="serviceSelect" class="form-select form-control-glass border-start-0 ps-0" onchange="updateStepProgress()">
                        <option value="">-- Chọn dịch vụ khám hoặc spa --</option>
                        <c:forEach items="${services}" var="s">
                            <option value="${s.id}">${s.serviceName} - <fmt:formatNumber value="${s.price}" pattern="#,##0"/> VNĐ</option>
                        </c:forEach>
                    </select>
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <select name="doctorId" id="doctorSelect" class="form-select form-control-glass border-start-0 ps-0" onchange="updateStepProgress(); fetchSlots();">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="appointmentDate" id="appointmentDate" class="form-control form-control-glass border-start-0 ps-0" placeholder="Bấm vào đây để chọn ngày khám...">
                </div>
